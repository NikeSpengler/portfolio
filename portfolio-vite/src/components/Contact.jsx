...
function Contact() {
  return (
    <div id="Contact" className="bg-lime-800 text-black min-h-screen px-4 flex flex-col justify-center">
         <div className='space-y-5 top-0 flex flex-col p-6'>
            <h1 className="text-4xl font-light text-black md:text-5xl">Contact me!</h1>
