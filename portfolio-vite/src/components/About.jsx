    ...
    return (
        ...
        <div id="About" className="flex flex-col justify-center items-center bg-stone-100 text-white md:px-20 px-14">
            ...
            <motion.div 
                ...
                >
                <p className="flex flex-col text-base text-stone-900 pt-20 md:pt-[150px] md:text-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl">
            ...
            >
                <p className="flex flex-col text-base text-stone-900 pt-10 pb-20 md:pb-[150px] md:text-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl">
